...
export default function Home() {
  ...
  return (
    <main className="shell">
      ...
      {editor && <EditorModal editor={editor} setEditor={setEditor} policies={policies} onSubmit={submitEditor} onImportCatalog={importCatalogRules} />}
...
function EditorModal({ editor, setEditor, policies, onSubmit, onImportCatalog }: { editor: Editor; setEditor: (value: Editor | null) => void; policies: string[]; onSubmit: (event: FormEvent) => void; onImportCatalog: (items: CatalogResult[], policy: string) => void }) {
