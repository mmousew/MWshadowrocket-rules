...
export default function Home() {
  ...
  function submitEditor(event: FormEvent) {
    ...
    if (editor.mode === "group") {
      ...
      const newLines = values.map((value) => [editor.type, value, editor.policy, ...options].join(","));
      if (editor.index === null) {
