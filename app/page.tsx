...
function ClashSubscription() {
  ...
  type SourceRecord = { index: number; name: string; kind: "url" | "content"; hidden: boolean; nodes: number | null };
